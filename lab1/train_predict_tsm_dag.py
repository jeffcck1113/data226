...
with DAG(
    ...
    train_input_table = "dev.raw_data.tsm_price"
    train_view = "dev.adhoc.tsm_price_view"
    forecast_table = "dev.adhoc.tsm_price_forecast"
    forecast_function_name = "dev.analytics.predict_tsm_price"
    final_table = "dev.analytics.tsm_price_7days_prediction"
